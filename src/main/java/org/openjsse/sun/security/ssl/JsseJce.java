...
import static org.openjsse.sun.security.ssl.OpenJSSE.cryptoProvider;
...
final class JsseJce {
    ...
    private static final class SunCertificates extends Provider {
        ...
        SunCertificates(final Provider p) {
            super("SunCertificates", PROVIDER_VER, "OpenJSSE internal");
    ...
    static Signature getSignature(String algorithm)
        ...
        if (cryptoProvider == null) {
            ...
            if (algorithm == SIGNATURE_SSLRSA) {
                ...
                // the OpenJSSE implementation does the actual crypto using
