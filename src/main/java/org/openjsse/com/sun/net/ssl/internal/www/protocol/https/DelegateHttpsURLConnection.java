...
public class DelegateHttpsURLConnection extends AbstractDelegateHttpsURLConnection {
    ...
    public org.openjsse.com.sun.net.ssl.HttpsURLConnection httpsURLConnection;

    DelegateHttpsURLConnection(URL url,
            sun.net.www.protocol.http.Handler handler,
            org.openjsse.com.sun.net.ssl.HttpsURLConnection httpsURLConnection)
            throws IOException {
...
class VerifierWrapper implements javax.net.ssl.HostnameVerifier {
    ...
    @SuppressWarnings("deprecation")
    VerifierWrapper(org.openjsse.com.sun.net.ssl.HostnameVerifier verifier) {
