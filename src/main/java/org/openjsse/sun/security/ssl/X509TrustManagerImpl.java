...
import org.openjsse.sun.security.validator.*;

/**
 * This class implements the OpenJSSE X.509 trust manager using the internal
...
final class X509TrustManagerImpl extends X509ExtendedTrustManager
    ...
    // Also used by X509KeyManagerImpl
    static List<SNIServerName> getRequestedServerNames(javax.net.ssl.SSLEngine engine) {
        if (engine != null) {
            SSLSession session = engine.getHandshakeSession();
