...
enum SSLExtension implements SSLStringizer {
    ...
    CH_CERTIFICATE_AUTHORITIES (0x002F, "certificate_authorities",
                                ...
                                CertificateAuthorityExtension.chOnLoadConsumer,
                                null,
                                CertificateAuthorityExtension.chOnTradeConsumer,
                                null,
                                CertificateAuthorityExtension.ssStringizer),
    CR_CERTIFICATE_AUTHORITIES (0x002F, "certificate_authorities",
                                SSLHandshake.CERTIFICATE_REQUEST,
                                ProtocolVersion.PROTOCOLS_OF_13,
                                CertificateAuthorityExtension.crNetworkProducer,
                                CertificateAuthorityExtension.crOnLoadConsumer,
                                null,
                                CertificateAuthorityExtension.crOnTradeConsumer,
                                null,
                                CertificateAuthorityExtension.ssStringizer),
